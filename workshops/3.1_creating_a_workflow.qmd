...
<TODO_container> {
  enabled = true
  autoMounts = true
  cacheDir = "/config/binaries/<TODO_container>/containers_devel/nextflow"
}
```
...
```default
process INDEX {
    container "/config/binaries/<TODO_container>/containers_devel/nextflow/depot.galaxyproject.org-<TODO_container>-salmon-1.10.1--h7e5ed60_0.img"
...
```default
/config/binaries/<TODO_container>/containers_devel/nextflow/depot.galaxyproject.org-<TODO_container>-salmon-1.10.1--h7e5ed60_0.img
```
...
```default
/config/binaries/<TODO_container>/containers_devel/nextflow/depot.galaxyproject.org-<TODO_container>-fastqc-0.12.1--hdfd78af_0.img
```
...
```default
process FASTQC {
    container "/config/binaries/<TODO_container>/containers_devel/nextflow/depot.galaxyproject.org-<TODO_container>-fastqc-0.12.1--hdfd78af_0.img"
...
process MULTIQC {
    ...
    container "/config/binaries/<TODO_container>/containers_devel/nextflow/depot.galaxyproject.org-<TODO_container>-multiqc-1.21--pyhdfd78af_0.img"
